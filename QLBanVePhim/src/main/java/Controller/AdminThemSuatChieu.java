...
/**
 * Servlet implementation class AdminThemSuatChieu
 */
@WebServlet("/AdminThemSuatChieu")
public class AdminThemSuatChieu extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// Chuyen trang
		RequestDispatcher rd = request.getRequestDispatcher("adminThemSuatChieu.jsp");
